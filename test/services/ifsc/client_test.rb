...
module Ifsc
  class ClientTest < ActiveSupport::TestCase
    test "fetches seasons index" do
      stub_response = Rails.root.join("test/fixtures/files/ifsc_seasons_response.json").read
    ...
    test "fetches event results" do
      stub_response = Rails.root.join("test/fixtures/files/ifsc_event_results_response.json").read
      stubs = Faraday::Adapter::Test::Stubs.new do |stub|
    ...
    test "fetches category results" do
      stub_response = Rails.root.join("test/fixtures/files/ifsc_category_results_response.json").read
      stubs = Faraday::Adapter::Test::Stubs.new do |stub|
